...
html_file = 'Datas/Maps/page4_map.html'

# Render the map visualization
st.title("**Unemployment Data Map**")

# Provide a detailed explanation with proper formatting
st.markdown("""
- **Number of initial claims:** Per 100 people in the 2019 labor force, Regular UI only
...
data = pd.read_csv("Datas/Chart Datas/unemp_df_chart.csv")
